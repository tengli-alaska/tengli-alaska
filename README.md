...
- Contributing performance fixes to **[ONNX Runtime](https://github.com/microsoft/onnxruntime/issues/27190)** — diagnosed and resolved a 17–28% AveragePool regression by identifying a compiler auto-vectorization blocker in the CPU execution provider
